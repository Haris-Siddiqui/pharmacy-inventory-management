    ...
    <div className="p-5">
      ...
      <div className="mt-3 w-full flex justify-between">
        <div className="border  p-2 rounded-lg">
          <select name="" id="" className=" border-none focus:outline-none  flex items-center">
        ...
        <div>
          <button className="p-2  bg-black text-white font-semibold rounded-lg"   onClick={() => setIsModal(true)}>
            Add Category
          </button>
        </div>
      </div>
                    ...
                    <div className="flex flex-col gap-3 justify-around items-center w-full h-full">
                     <h1 className="text-2xl font-semibold">
                      ...
                      <div className="w-full flex justify-center flex-col gap-2">
                        ...
                        <input type="text"    className="w-full p-2 border focus:outline-none cursor-pointer rounded-lg" placeholder="Category Name"/>
                      </div>
